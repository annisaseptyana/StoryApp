...
class StoryPagingSource(private val token: String, private val apiService: ApiService): PagingSource<Int, StoryListResponseItem>() {

    private companion object {
        const val INITIAL_PAGE_INDEX = 1
    }

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, StoryListResponseItem> {
    ...
    override fun getRefreshKey(state: PagingState<Int, StoryListResponseItem>): Int? {
